...
Version 0.90.19 - Pure Pygame Implementation (Increase Header Font Size)
...
Version 0.90.19 Changes:
- Increased "Now Playing" header from 20pt to 26pt bold
- Increased "CREDITS" display from 20pt to 26pt bold
- Makes key headers more prominent and easier to read
- Other fonts remain: 18pt (song title/upcoming), 16pt (artist), 12pt (details)
...
def main():
    ...
    print("Convergence Jukebox v0.90.19 - Increase Header Font Size to 26pt")
