"""
Music File Cleaner v0.00.72
Fixed window size to 1024x600 (smaller) with resizable controls.
Window now clearly shows title bar with minimize/maximize/close buttons.
"""
