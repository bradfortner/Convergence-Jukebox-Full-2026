                        ...
                        try:
                            ...
                            if current_time_ms > 0 and duration_ms > 0:
                                ...
                                if should_show:
                                    ...
                                    # NUCLEAR OPTION: Just hide everything and show black screen with popup
                                    # We've tried everything else - this is the ONLY thing that works
                                    print("Hiding ALL windows for popup display...")
