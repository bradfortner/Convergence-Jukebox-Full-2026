...
Version 0.90.14 - Pure Pygame Implementation (Remove All Character Limits)
...
Version 0.90.14 Changes:
- Removed all character limits from info screen displays
- Large title: was 20 chars, now unlimited
- Large artist: was 24 chars, now unlimited
- Upcoming songs: was 22 chars each, now unlimited
- Button grid titles: was 22 chars, now unlimited
- Button grid artists: was 22 chars, now unlimited
- Test version to evaluate visual appearance with full-length text

Next Steps:
- Evaluate visual appearance and adjust limits as needed
...
def main():
    ...
    print("Convergence Jukebox v0.90.14 - Remove All Character Limits")
