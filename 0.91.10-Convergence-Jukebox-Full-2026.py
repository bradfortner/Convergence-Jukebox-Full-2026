...
Version 0.91.10 - Genre Filter Immediate Apply Fix

This version fixes a bug where changing genre filters in the Operator Control Panel
would not take effect until the program was restarted. Genre filters now regenerate
the random playlist immediately after saving, matching the behavior of year range filters.
