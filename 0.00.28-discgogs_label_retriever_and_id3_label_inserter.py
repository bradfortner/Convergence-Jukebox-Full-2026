"""
Music File Cleaner v0.00.28
Increase auto-advance limit to 20 releases
...
class EnhancedInputBox:
    ...
    def _get_cursor_from_click(self, click_x):
        ...
        char_width = FONT.size('M')[0]  # Use 'M' as average width
        estimated_pos = int(click_x / char_width)
        return max(0, min(len(self.text), estimated_pos))
