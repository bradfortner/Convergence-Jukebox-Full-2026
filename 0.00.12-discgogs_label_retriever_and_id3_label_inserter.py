"""
Music File Cleaner v0.00.12
EARLY OCR VALIDATION - Check artist/title match on raw Discogs images before processing
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.12")
