...
Version 0.90.44 - Test Without Success Sound
...
Version 0.90.44 Changes:
- TESTING: Disabled success_sound.play() to see if it's causing popup code to skip
- Hypothesis: sound.play() may be crashing silently and jumping execution
- Added DEBUG-2 print to confirm this section executes

Version 0.90.43 Changes:
- DEBUGGING: Added 5 debug print statements to trace popup generation code path
- Trying to find why selection popup isn't displaying after song selection
...
def main():
    ...
    print("Convergence Jukebox v0.90.44 - Test Without Success Sound")
                    ...
                    if selection_entry_letter is not None and selection_entry_number is not None:
                        if credits > 0:
                            ...
                            if song_index < len(song_list):
                                ...
                                print("[DEBUG-1] After adding to upcoming list")

                                # Play success sound
                                #if success_sound:
                                #    print("[DEBUG-2] About to play success sound")
                                #    success_sound.play()
                                #    print("[DEBUG-3] Success sound played")
                                #print("[DEBUG-4] After success sound section")
                                print("[DEBUG-2] SKIPPED SUCCESS SOUND TO TEST")

                                # Generate and show selection popup
                                print("[DEBUG-5] About to generate selection popup...")
                                try:
