"""
Music File Cleaner v0.00.11
PERFORMANCE OPTIMIZATIONS - Parallel downloads, caching, reduced redundancy
    ...
    def _update_with_current_discogs_result(self):
        ...
        def fetch_worker():
            ...
            try:
                ...
                # v0.00.11: Download ALL images and filter in parallel (OPTIMIZED)
                filtered_images = download_and_filter_images_parallel(release, max_workers=5)
    ...
    def update(self):
        ...
        if self.fetch_thread and not self.fetch_thread.is_alive():
            ...
            if release:
                ...
                if label_count > 0 and self.auto_advance_attempts > 0:
...
def download_and_filter_images_parallel(release, max_workers=5):
    """
    ...
    def download_single_image(idx, img_info):
        """Worker function to download and detect circles for one image"""
        try:
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.11")
