...
Version 0.91.07 - Genre Flags Consolidation

This version moves genre filter settings from GenreFlagsList.txt into user_config.txt
for better organization and centralized configuration management.
