...
Version 0.90.17 - Pure Pygame Implementation (Change Font to Rockwell)
...
Version 0.90.17 Changes:
- Changed all fonts from Century Gothic to Rockwell
- Button grid fonts: Rockwell (song titles and artist names)
- Info screen fonts: Rockwell (all sizes: 20pt, 18pt, 16pt, 12pt)
- Rockwell is a slab serif font that gives a strong vintage jukebox aesthetic

Next Steps:
- Add 45rpm selection popup
- Add rotating record idle popup
...
class ButtonGrid:
    ...
    def __init__(self, start_x, start_y, song_list, selection_window_number=0):
        ...
        # Create fonts
        self.font_id = pygame.font.SysFont('rockwell', 16, bold=True)
        self.font_song = pygame.font.SysFont('rockwell', 12, bold=True)
...
class InfoScreen:
    ...
    def __init__(self, start_x, start_y, song_list):
        ...
        # Create fonts
        self.font_header_large = pygame.font.SysFont('rockwell', 20, bold=True)
        self.font_header_medium = pygame.font.SysFont('rockwell', 18, bold=True)
        self.font_song_title = pygame.font.SysFont('rockwell', 18, bold=True)
        self.font_song_artist = pygame.font.SysFont('rockwell', 16, bold=True)
        self.font_info = pygame.font.SysFont('rockwell', 12, bold=True)
        self.font_credits = pygame.font.SysFont('rockwell', 20, bold=True)
...
def main():
    ...
    print("Convergence Jukebox v0.90.17 - Rockwell Font")
