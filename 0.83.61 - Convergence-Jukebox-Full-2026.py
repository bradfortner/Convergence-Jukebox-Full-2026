...
Version 0.83.61 - Left-Justified Text Truncation for Song Selection Display
...
Version 0.83.61 Changes:
- ADDED format_button_text() function to font_size_window_updates_module.py
- MODIFIED update_selection_button_text() to truncate song titles/artists at 22 characters
...
Version 0.83.60 Changes:
- Rolled back to commit 289ec67 (stable v0.83.51 before popup experiments)
- Removed all pygame popup window z-order experiments (v0.83.52-59)
- Rotating record popup functionality present but may not display properly
- This is the last known stable version before window management debugging
- Use this as baseline for future popup development
"""
