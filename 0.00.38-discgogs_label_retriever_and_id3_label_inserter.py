"""
Music File Cleaner v0.00.38
Debug verification flags after FileDisplay creation
...
- **AUTO-SELECT VERIFIED LABELS**:
  1. When label passes verification (green "VERIFIED ✓"), automatically checks "Use This Label" checkbox
...
- **AUTOMATED VERIFICATION SYSTEM**:
  ...
  2. Displays prominent visual banner at top of screen:
     - Green "VERIFIED ✓" when both checks pass
     - Yellow/Orange warning when checks fail with specific reason
  3. Shows detailed status: "Structural: ✓/✗  |  OCR Match: ✓/✗"
...
class FileDisplay:
    ...
    def _generate_adaptor_preview(self, recursion_depth=0):
        ...
        try:
            ...
            print("="*60)
            print("✓ Structural validation: PASSED (valid 45rpm label structure)")
            print(f"✓ OCR validation: PASSED ('{self.artist}' - '{self.title}' found on label)")
            print("\n" + "="*60)
            print("FINAL VERDICT: VERIFIED ✓")
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if self.adaptor_preview_rect.collidepoint(event.pos) and self.adaptor_preview_surface:
                ...
                if self.verification_passed:
                    print("\n✓ Label VERIFIED - Jumping directly to ConfirmationScreen")
        ...
        if self.final_record_surface:
            ...
            try:
                ...
                if self.structural_valid:
                    ...
                    print("✗ Structural validation: FAILED (malformed label/adaptor)")
            except Exception as e:
            ...
            try:
                ...
                if filename_artist and filename_title:
                    ...
                    if self.ocr_valid:
                        print(f"✓ OCR validation: PASSED ('{filename_artist}' - '{filename_title}' found on label)")
                    else:
                        print(f"✗ OCR validation: FAILED (artist/title not found or below 70% threshold)")
                else:
                    print("✗ OCR validation: SKIPPED (missing filename artist/title)")
                    self.ocr_valid = False
            except Exception as e:
            ...
            if self.verification_passed:
                self.verification_message = "VERIFIED ✓"
                print("\n" + "="*60)
                print("FINAL VERDICT: VERIFIED ✓")
                ...
                print("✓ Auto-checked 'Use This Label' (label is verified)")
                ...
                print(f"✓ Will use OCR-verified data: '{filename_artist}' - '{filename_title}'")
            else:
    ...
    def draw(self):
        ...
        if self.final_record_surface:
            ...
            if self.structural_valid and self.ocr_valid:
                detail_text = "Structural: ✓  |  OCR Match: ✓"
