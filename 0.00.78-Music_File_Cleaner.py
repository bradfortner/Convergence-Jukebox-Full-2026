"""
Music File Cleaner v0.00.78
Fixed discogs list mode to skip already-processed files (comment contains "image" or "noimage")
"""
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.78")
