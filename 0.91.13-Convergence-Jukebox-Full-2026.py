...
Version 0.91.13 - Fix ID3 Album Art for Rotating Record Popup During Playback

This version fixes a bug where the rotating record popup (idle screensaver shown during
playback) would not display ID3 album art. The same bug as 0.91.12 existed in the
rotating record code - manually constructed file path instead of using actual location.
