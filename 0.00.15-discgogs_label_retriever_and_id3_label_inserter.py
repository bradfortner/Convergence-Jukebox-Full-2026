"""
Music File Cleaner v0.00.15
PROGRESS BAR - Visual progress indicator during genre scanning
...
def scan_all_genres(music_files, screen=None):
    ...
    for i, music_file in enumerate(music_files):
        # Update progress bar every 10 files (or always if less than 100 files)
        if screen and (i % 10 == 0 or total_files < 100):
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.15")
