...
Version 0.91.15 - Add 45 RPM Animation On/Off Toggle to Operator Control Panel

This version adds a new option in the More Selections submenu of the Operator Control
Panel that allows the operator to enable or disable the rotating record (45 RPM)
idle animation. The setting persists in user_config.txt. Default is ON.
