...
Version 0.90.12 - Pure Pygame Implementation (Fix: Upcoming Selections Display)
...
Version 0.90.12 Changes:
- Added song numbers to upcoming selections (1. Song - Artist, 2. Song - Artist, etc.)
- Fixed upcoming list: removes currently playing song from top of list when it starts
- Maintains separate UpcomingSongPlayList for display (formatted title - artist strings)
- Updates upcoming display when song starts playing and when new songs are selected
- Matches original display format exactly
...
def main():
    ...
    print("Convergence Jukebox v0.90.12 - Upcoming Selections Display Fixed")
