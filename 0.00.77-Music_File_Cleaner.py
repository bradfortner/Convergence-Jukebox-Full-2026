"""
Music File Cleaner v0.00.77
Added 4th search option: "Search From Discogs Text List"
Reads discogs_search_list.txt (comma-separated filenames) and processes each song in the list order.
"""

import pygame
import discogs_client
import music_file_cleaner_config
import json
import requests
import io
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.77")
                    ...
                    if search_config and search_config['mode'] == 'from_discogs_list':
                        ...
                        if search_config['list_index'] >= len(search_config['song_list']):
                            ...
                            if current_file_index == -1:
                                ...
                                search_result.clear()
                                bypass = True  # Always bypass skip for discogs list mode
