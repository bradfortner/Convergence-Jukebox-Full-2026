...
Version 0.90.16 - Pure Pygame Implementation (Change Font to Century Gothic)
...
Version 0.90.16 Changes:
- Changed all fonts from Helvetica to Century Gothic
...
- Gives jukebox a more retro/vintage aesthetic
...
def main():
    ...
    print("Convergence Jukebox v0.90.16 - Century Gothic Font")
