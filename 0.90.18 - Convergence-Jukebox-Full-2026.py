...
Version 0.90.18 - Pure Pygame Implementation (Change Font to Century Gothic)
...
Version 0.90.18 Changes:
- Changed all fonts from Rockwell back to Century Gothic
- Button grid fonts: Century Gothic (song titles and artist names)
- Info screen fonts: Century Gothic (all sizes: 20pt, 18pt, 16pt, 12pt)
- Century Gothic provides a clean, geometric sans-serif look with retro appeal
...
class ButtonGrid:
    ...
    def __init__(self, start_x, start_y, song_list, selection_window_number=0):
        ...
        self.font_song = pygame.font.SysFont('centurygothic', 12, bold=True)
...
class InfoScreen:
    ...
    def __init__(self, start_x, start_y, song_list):
        ...
        # Create fonts
        self.font_header_large = pygame.font.SysFont('centurygothic', 20, bold=True)
        ...
        self.font_credits = pygame.font.SysFont('centurygothic', 20, bold=True)
...
def main():
    ...
    print("Convergence Jukebox v0.90.18 - Century Gothic Font")
