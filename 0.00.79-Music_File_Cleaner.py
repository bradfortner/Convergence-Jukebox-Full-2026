"""
Music File Cleaner v0.00.79
Auto-populate Comment field with "noimage" when Edit ID3 Tags screen opens
"""
...
class ID3EditScreen:
    def __init__(self, screen, data_bundle):
        ...
        self.comment = 'noimage'  # Auto-populate with "noimage"
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.79")
