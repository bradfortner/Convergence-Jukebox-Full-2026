...
class FileDisplay:
    ...
    def _update_with_current_discogs_result(self):
        # This method is now more complex as it needs to re-fetch release details.
        # For now, we simplify and assume the first result is the one we want.
        # A more advanced implementation might re-trigger a threaded fetch here.
        print("Cycling through multiple Discogs results is not yet re-implemented in threaded mode.")
        pass
        
    def _get_song_length_and_genres(self):
        # This method is safe as it just processes data already in memory
