...
Version 0.91.12 - Fix ID3 Album Art and Artist Name for Paid Song Selection Popup

This version fixes two bugs in the 45rpm selection popup (shown when user selects
a paid song). The ID3 album art was not displayed because of an incorrect file path,
and the artist_name variable was undefined causing a crash.
