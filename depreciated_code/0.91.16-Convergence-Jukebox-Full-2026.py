...
Version 0.91.16 - Smooth 45 RPM Vinyl Spinning Animation

This version optimizes the rotating record (45 RPM) popup animation for smoother
playback by pre-calculating rotated frames at popup startup instead of rotating
the surface every frame, using anti-aliased rotozoom, and enabling hardware acceleration.
...
def load_popup_animation_setting():
    """
...
def save_popup_animation_setting(enabled):
    """
...
def main():
    ...
    while running:
        ...
        if (playback_engine.current_song_index is not None and
            ...
            try:
                ...
                if prep_image and os.path.exists(prep_image):
                    ...
                    prepped_rotated_frames = [pygame.transform.rotozoom(prep_surface, angle, 1.0) for angle in range(360)]
                    ...
                    if should_show:
                        ...
                        if prepped_song_index == playback_engine.current_song_index and prepped_rotated_frames:
                            ...
                            if popup_record_image and os.path.exists(popup_record_image):
                                ...
                                popup_rotated_frames = [pygame.transform.rotozoom(popup_record_surface, angle, 1.0) for angle in range(360)]
        ...
        if popup_active and popup_rotated_frames and popup_tonearm:
            ...
            frame_index = int(popup_rotation_angle) % 360
