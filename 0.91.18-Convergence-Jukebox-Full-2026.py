...
Version 0.91.18 - Performance Polish & Cleanup

This version addresses remaining performance issues identified during code review:
cached text rendering, deque-based random playlist, consolidated imports, and cleanup.
