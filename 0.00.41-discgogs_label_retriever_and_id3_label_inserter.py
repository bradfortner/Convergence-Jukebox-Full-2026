...
def main():
    ...
    while not done:
        ...
        if app_state == "file_display" and file_display:
            ...
            # v0.00.40: Check for auto-jump AFTER update() (when background thread completes)
            # Only jump if we haven't already checked (prevent multiple jumps)
            if file_display.verification_passed and not hasattr(file_display, 'auto_jump_attempted'):
                file_display.auto_jump_attempted = True  # Mark as attempted
