        ...
        if app_state == "search_options":
            ...
            if search_thread is not None and not search_thread.is_alive():
                ...
                if fetched_data and fetched_data.get('discogs_results'):
                    ...
                    # v0.00.38: Debug - check verification flags after FileDisplay created
                    print(f"\n[DEBUG] After FileDisplay created:")
                    print(f"  verification_passed = {file_display.verification_passed}")
                    print(f"  structural_valid = {file_display.structural_valid}")
                    print(f"  ocr_valid = {file_display.ocr_valid}")

                    # v0.00.37: Check if label was verified - if so, AUTO-JUMP to ConfirmationScreen immediately
                    if file_display.verification_passed:
                        print("\n" + "="*60)
                        print("AUTO-JUMP: Label verified - going directly to ConfirmationScreen")
                        print("="*60 + "\n")
                        ...
                        # Not verified - show FileDisplay for manual review
                        app_state = "file_display"
                        current_status = "Ready"
