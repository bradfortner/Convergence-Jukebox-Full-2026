...
Version 0.91.09 - User Config Initialization

This version adds user_config.txt creation to the setup_files() initialization function,
ensuring all default settings are properly initialized on first run.
