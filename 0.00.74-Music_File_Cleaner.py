"""
Music File Cleaner v0.00.74
Changed directory from 'processed' to 'Music' for all read/write operations.
Now reads MP3 files from ./Music/ directory instead of ./processed/ directory.
"""
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.74")
