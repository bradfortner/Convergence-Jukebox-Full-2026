...
Version 0.91.05 - Improved Dual Year Wheel Interface

This version fixes the year range selection interface to have two properly
functioning year wheels with improved user interaction flow.
