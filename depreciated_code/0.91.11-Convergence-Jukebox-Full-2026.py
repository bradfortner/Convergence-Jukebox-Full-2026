...
Version 0.91.11 - Random Music Toggle Auto-Start Fix

This version fixes a bug where enabling random music from a disabled state would not
start playback if the jukebox was silent. When random music is enabled, the playlist
is now generated and playback starts immediately if no music is playing.
