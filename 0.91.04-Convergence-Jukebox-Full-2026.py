...
Version 0.91.04 - Year Range Filter for Random Playlist

This version implements a year range filter in the operator control panel,
allowing the jukebox operator to restrict random playlist songs to a specific
year range (e.g., only play songs from 1960-1979).
...
- user_config.txt now stores: {"access_code": ["7","7","7","7"], "random_music_enabled": true, "credits_enabled": true, "year_range_enabled": false, "year_range_start": 1010, "year_range_end": 2017}
...
from operator_panel_module import display_operator_panel, select_random_music_genres, toggle_random_music, toggle_credits, select_year_range
...
class PlaybackEngine:
    ...
    def __init__(self, song_list, paid_playlist_path, random_music_enabled=True):
        ...
        self.year_range_start = 1010
        self.year_range_end = 2017
    ...
    def set_random_music_enabled(self, enabled):
...
def save_access_code(code):
    ...
    try:
        ...
        config = {
            ...
            "year_range_start": 1010,  # Default
            "year_range_end": 2017  # Default
        }
...
def save_random_music_setting(enabled):
    """
...
def save_credits_enabled(enabled):
    """
            ...
            with open('user_config.txt', 'r') as f:
                ...
                try:
                    ...
                    if isinstance(config, dict):
                        ...
                        start_year = config.get('year_range_start', 1010)
                        end_year = config.get('year_range_end', 2017)
...
def save_year_range_settings(enabled, start_year, end_year):
    """
...
def main():
    ...
    while running:
        ...
        if show_control_panel:
            ...
            elif operator_action == "For Future Use":
                print("Action: Year Range For Future Use")
