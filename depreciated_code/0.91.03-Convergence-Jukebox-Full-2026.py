...
Version 0.91.03 - Credits On/Off Toggle (Free Play Mode)

This version implements a credits on/off toggle in the operator control panel,
allowing the jukebox to operate in free play mode where users can select songs
without inserting quarters.
...
from operator_panel_module import display_operator_panel, select_random_music_genres, toggle_random_music, toggle_credits
