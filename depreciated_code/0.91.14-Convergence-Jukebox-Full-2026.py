...
Version 0.91.14 - Add Success Sound and Selection Popup to Mouse Click SELECT

This version fixes a bug where mouse/touchscreen clicks on the SELECT button did not
play the success sound or show the selection popup. The keyboard S key path had both
features, but the mouse click handler was missing them entirely.
