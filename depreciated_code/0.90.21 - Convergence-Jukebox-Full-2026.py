...
Version 0.90.21 - Pure Pygame Implementation (Adjust Button Grid Font Size to 14pt)
...
Version 0.90.21 Changes:
- Changed button grid song titles from 16pt to 14pt bold
- Changed button grid artist names from 16pt to 14pt bold
- Button IDs remain 16pt bold (A1, B2, C3, etc.)
- Provides better balance between readability and space
...
def main():
    ...
    print("Convergence Jukebox v0.90.21 - Adjust Button Grid Font Size to 14pt")
