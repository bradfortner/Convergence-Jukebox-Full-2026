"""
Music File Cleaner v0.00.03
Auto-generate adaptor-inserted preview on main FileDisplay browsing screen
...
class FileDisplay:
    ...
    def _generate_adaptor_preview(self):
        """
        v0.00.03: Auto-generate preview of label with adaptor inserted
        for display on FileDisplay browsing screen
        """
        try:
            print("Generating adaptor preview for FileDisplay...")
            ...
            # Step 2: Save cropped label to temp file
            temp_label_path = 'temp_preview_label.png'
            pygame.image.save(cropped_label_surface, temp_label_path)

            # Step 3: Generate final preview with adaptor using label_pressing_module
            temp_preview_path = 'temp_preview_with_adaptor.png'
            ...
            if not success:
                print("Failed to generate adaptor preview")
                self.adaptor_preview_surface = None
                return

            # Step 4: Load the preview image as a surface
            self.adaptor_preview_surface = pygame.image.load(temp_preview_path)
            print("✓ Adaptor preview generated successfully")
