"""
Music File Cleaner v0.00.73
CRITICAL FIX: Skip logic now properly prevents Discogs queries for processed files.
Added should_query_discogs flag to ensure files with "image"/"noimage" in comment
tags are never sent to Discogs, preventing API rate limiting.
"""
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.72")
