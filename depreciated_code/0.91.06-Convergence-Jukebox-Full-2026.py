...
Version 0.91.06 - Year Range Default & Menu Update

This version sets the default year to 1967 and updates the menu item text
from "For Future Use" to "Select Year Range" for clarity.
