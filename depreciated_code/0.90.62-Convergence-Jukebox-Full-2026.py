...
Version 0.90.61 - Fix ID3 Image Detection Bug
...
from the_bands_name_check import load_the_bands_data, apply_the_prefix
...
class ButtonGrid:
    ...
    def __init__(self, start_x, start_y, song_list, selection_window_number=0):
        ...
        self.the_bands_set, self.exempted_bands_list = load_the_bands_data()
        ...
        for row in range(1, 8):
            ...
            for col_idx, col_letter in enumerate(columns):
                ...
                if song_idx < len(self.song_list):
                    ...
                    artist_text = apply_the_prefix(artist_text, self.the_bands_set, self.exempted_bands_list)
...
def draw_control_panel(screen):
    """Draws the operator control panel."""
    # Define fonts
    title_font = pygame.font.Font('fonts/Montserrat-Bold.ttf', 48)
    button_font = pygame.font.Font('fonts/Montserrat-Bold.ttf', 28)

    # Fill background
    screen.fill((20, 20, 40)) # Dark blue background

    # Draw title
    title_text = title_font.render("Operator Control Panel", True, COLOR_WHITE)
    title_rect = title_text.get_rect(center=(SCREEN_WIDTH // 2, 100))
    screen.blit(title_text, title_rect)

    # Draw Exit button
    exit_button_rect = pygame.Rect(0, 0, 200, 80)
    exit_button_rect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT - 100)
    pygame.draw.rect(screen, (150, 0, 0), exit_button_rect) # Red button
    pygame.draw.rect(screen, COLOR_WHITE, exit_button_rect, 3) # White border
...
def main():
    ...
    the_bands_set, exempted_bands_list = load_the_bands_data()
    ...
    while running:
        ...
        if show_control_panel:
            exit_button_rect = draw_control_panel(screen)
