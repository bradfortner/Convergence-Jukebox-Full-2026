...
def rotate_record_pygame(image_path, rotation_stop_flag, window_x, window_y, window_width, window_height, no_titlebar=True):
    ...
    try:
        ...
        # Scale record to fit window with room for tonearm (240x240 for 420x420 window)
        record_display_size = int(window_width * 0.57)  # ~240px for 420px window
        ...
        tonearm_pivot_y = int(window_height * 0.70)  # ~294 for 420px window
        tonearm_length = int(window_width * 0.43)    # ~180 for 420px window
