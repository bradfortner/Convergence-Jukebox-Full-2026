        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_TAB:
                ...
                if focused_widget == self.next_music_file_button:
                    ...
                    # TODO: Implement update data and use ID3 image functionality
                    print("Update Data And Use ID3 Image button pressed")
                    return None, None
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if self.show_confirmation_buttons:
                if self.are_you_sure_button.rect.collidepoint(event.pos):
                    ...
                    print("==========================================\n")
                    print("Are You Sure button pressed - file write functionality to be implemented")
                    return None
