...
Version 0.91.17 - Stability, Performance & Nuitka Prep

This version addresses critical audio correctness, performance, and stability issues
identified during comprehensive code review in preparation for Nuitka C compilation.
