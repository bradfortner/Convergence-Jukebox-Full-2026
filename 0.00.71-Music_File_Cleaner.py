"""
Music File Cleaner v0.00.71
Added resizable window with window bar controls (minimize, maximize, close).
Users can now minimize the application while it's running.
"""
