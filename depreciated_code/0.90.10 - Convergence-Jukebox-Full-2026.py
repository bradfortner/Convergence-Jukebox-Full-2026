...
Version 0.90.10 - Pure Pygame Implementation (Fix: Info Screen Labels)
...
Version 0.90.10 Changes:
- Fixed info screen: added missing "Title:", "Artist:", and "Album:" labels
- Format matches original: "  Title: {title}", "  Artist: {artist}", "  Album: {album}"
- Leading spaces preserved for proper alignment
...
def main():
    ...
    print("Convergence Jukebox v0.90.10 - Info Screen Labels Fixed")
