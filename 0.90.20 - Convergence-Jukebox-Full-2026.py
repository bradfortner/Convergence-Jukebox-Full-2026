...
Version 0.90.20 - Pure Pygame Implementation (Increase Button Grid Font Size)
...
Version 0.90.20 Changes:
- Increased button grid song titles from 12pt to 16pt bold
- Increased button grid artist names from 12pt to 16pt bold
- Makes song selection grid more readable and prominent
- Button IDs remain 16pt bold (A1, B2, C3, etc.)
...
class ButtonGrid:
    ...
    def __init__(self, start_x, start_y, song_list, selection_window_number=0):
        ...
        self.font_song = pygame.font.SysFont('centurygothic', 16, bold=True)
...
def main():
    ...
    print("Convergence Jukebox v0.90.20 - Increase Button Grid Font Size to 16pt")
