"""
Music File Cleaner v0.00.75
Renamed jukebox_config.py to music_file_cleaner_config.py for clarity.
Updated import statement to use new config module name.
"""
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.75")
