            ...
            if app_state == "search_options" and search_options_screen:
                ...
                if result:
                    ...
                    if action == "back_to_result":
                        ...
                        # v0.00.43: Don't reset file_display_prev_verified here!
                        # It will auto-reset when new data loads (verification goes False)
                        # Resetting here causes infinite auto-jump loop on same label
                        app_state = "file_display"
                        confirmation_screen = None
