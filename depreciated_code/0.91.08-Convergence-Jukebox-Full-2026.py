...
Version 0.91.08 - More Selections Submenu

This version activates the "More Selections" button on the Operator Control Panel
and implements a placeholder submenu for future feature expansion.
...
def setup_files():
    ...
    NOTE: Genre filter flags now stored in user_config.txt (as of v0.91.07)
    """
    from datetime import datetime
    ...
    # NOTE: Genre flags now stored in user_config.txt (as of v0.91.07)
    # GenreFlagsList.txt is no longer created or used
...
def save_genre_flags(genre_flags):
    """
...
def main():
    ...
    while running:
        ...
        if show_control_panel:
            ...
            # It displays a submenu with 5 "For Future Use" items and will return
            # "Return To Jukebox" when any item is selected from that submenu
