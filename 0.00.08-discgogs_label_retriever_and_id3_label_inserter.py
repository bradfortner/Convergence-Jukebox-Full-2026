...
class FileDisplay:
    ...
    def _generate_adaptor_preview(self, recursion_depth=0):
        ...
        try:
            ...
            # v0.00.08: Step 4: Validate the final combined image
            ...
            # Step 5: Load final_record.png as thumbnail surface (only if validation passed)
    ...
    def handle_event(self, event):
        ...
        if self.use_label_checkbox.checked and not was_checked_before:
            if not self.image_surface:
                ...
                # v0.00.08: Validate the final combined image before showing preview
                is_valid = validate_final_record('final_record.png', debug=True)
                ...
                # v0.00.02: Show preview comparison screen instead of confirmation (only if validation passed)
                preview_data = {
