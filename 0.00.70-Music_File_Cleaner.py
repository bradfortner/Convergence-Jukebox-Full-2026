"""
Music File Cleaner v0.00.70
Added "Load 10 More?" checkbox that appears when reaching the last Discogs result
(e.g., result 10 of 10). When clicked, fetches 10 additional results.
"""
