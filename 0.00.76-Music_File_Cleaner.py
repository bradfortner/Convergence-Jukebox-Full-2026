"""
Music File Cleaner v0.00.76
Changed image file paths to use local directory instead of images/ subdirectory.
Files now read/written from root: adaptor.png, blank_record.png, new_cutout_label.png
"""
...
def main():
    ...
    pygame.display.set_caption("Music File Cleaner v0.00.76")
